...
### 默认播放（带控件）
<Video src="/videos/棒棒棒棒.mp4" title="五杀视频，帅哒" />

### 自动循环播放（无控件）
<Video src="/videos/棒棒棒棒.mp4" title="五杀自动循环播放示例" loop={true} />
...
<VideoDiff
  l="/videos/audience.mp4"
  r="/videos/hotZoneVisualization.mp4"
  leftAlt="观众"
  rightAlt="热力图"
/>
